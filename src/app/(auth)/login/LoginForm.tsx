  ...
  return (
    <div className="grid min-h-[calc(100vh-4rem)] lg:grid-cols-2">
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(120deg, rgba(26,60,52,0.85), rgba(26,60,52,0.45)), url(https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=1600&q=80)",
        }}
      >
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <p className="text-sm uppercase tracking-[0.2em] text-[var(--coral)]">NutriAI</p>
      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-[var(--forest)]">Welcome back</h2>
          <p className="mt-1 text-sm text-[var(--warm-gray)]">Sign in to continue to NutriAI</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              type="button"
              onClick={fillDemo}
              className="w-full rounded-xl border border-[var(--forest)] px-4 py-2.5 text-sm font-semibold text-[var(--forest)] hover:bg-[var(--sage)]"
            >
              Use Demo Account
            </button>
          ...
          <p className="mt-6 text-center text-sm text-[var(--warm-gray)]">
            ...
            <Link href="/register" className="font-semibold text-[var(--coral)]">
              Register here
            </Link>
          </p>
        </div>
